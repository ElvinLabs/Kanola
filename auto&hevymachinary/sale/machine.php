...
<head>
    ...
    <title>Kanola - Auto & Heavy machinary</title>
        ...
        <div class="row text-center">
        	...
        	<?php
                ...
                for ($i=0; $i <$length ; $i++) { 
                    ...
                    $filename = key($files["machines"][$i]);
                    $image_path = "../".$files["machines"][$i][$filename]["img_url"];
                    $category = $files["machines"][$i][$filename]["category"];
                    $brand = $files["machines"][$i][$filename]["brand"];
                    $model = $files["machines"][$i][$filename]["model"];
                    $modelyr = $files["machines"][$i][$filename]["model_year"];
                   ...
                   // print($image_path."<br>");
                    ...
                    <div class="col-md-3 col-sm-6 hero-feature"> 
                        ...
                        <a href="<?php echo("show machine.php?path=auto&name=".$filename); ?>" class="btn btn-default k-btn">More</a>
