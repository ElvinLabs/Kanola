...
<!-- *********************************  Highways  ongoing projects     *********************************************       -->
                    ...
                    <?php
                        ...
                        $query_ongoing_highways = "SELECT * FROM Highways WHERE Project_state='Ongoing'";
                    ...
                    ?>
                             ...
                             <div class="col-md-4 col-sm-4 proj">
                                ...
                                <form action='delete_project.php' method='POST'> 
                                    ...
                                    <input type='hidden' name='type' value='Highways'>
...
<!-- *********************************  Highways  complete projects     *********************************************       -->
                    ...
                    <?php
                        ...
                        $query_complete_highways = "SELECT * FROM Highways WHERE Project_state='Complete'";
